...
public static class DbInitializer
{
    public static async Task SeedAsync(AppDbContext context)
    {
        ...
        {
            new("Michael", "Brown", "michael@acme.com", "Password123", company1.Id, "Developer"),
            new("Emma", "Davis", "emma@acme.com", "Password123", company1.Id, "Designer"),
            new("David", "Wilson", "david@acme.com", "Password123", company1.Id, "Project Manager")
        };

        var employees2 = new List<Employee>
        {
            new("Robert", "Jones", "robert@techsolutions.com", "Password123", company2.Id, "Engineer"),
            new("Jennifer", "Garcia", "jennifer@techsolutions.com", "Password123", company2.Id, "QA Analyst")
        };
