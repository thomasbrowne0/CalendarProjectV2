...
public class CalendarAppService : ICalendarAppService
{
    ...
    public async Task<IEnumerable<CalendarEventDto>> GetEventsByCompanyIdAsync(Guid companyId, DateTime? startDate,
        DateTime? endDate)
    {
    ...
    public async Task<IEnumerable<CalendarEventDto>> GetEventsByEmployeeIdAsync(Guid employeeId, DateTime? startDate,
        DateTime? endDate)
    {
    ...
    public async Task<CalendarEventDto> CreateEventAsync(Guid companyId, Guid creatorId,
        ...
        try
        {
            ...
            if (eventDto.ParticipantIds != null && eventDto.ParticipantIds.Any())
                foreach (var participantId in eventDto.ParticipantIds)
                {
                    ...
                    if (employee != null && employee.CompanyId == companyId) calendarEvent.AddParticipant(employee);
                }
    ...
    public async Task<CalendarEventDto> UpdateEventAsync(Guid id, CalendarEventUpdateDto eventDto)
    {
        ...
        if (eventDto.ParticipantIds != null)
        {
            ...
            foreach (var participantId in participantsToRemove)
            {
                ...
                if (employee != null) calendarEvent.RemoveParticipant(employee);
            }
        }
